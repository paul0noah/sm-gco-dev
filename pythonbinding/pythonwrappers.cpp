...
PYBIND11_MODULE(sm_gco, handle) {
    ...
    py::enum_<COST_MODE>(handle, "COST_MODE")
            ...
            .value("MULTIPLE_LABLE_SPACE_GEODIST_MAX", MULTIPLE_LABLE_SPACE_GEODIST_MAX)
            .value("MULTIPLE_LABLE_SPACE_L2DIST", MULTIPLE_LABLE_SPACE_L2DIST)
            .value("MULTIPLE_LABLE_SPACE_L2DIST_MAX", MULTIPLE_LABLE_SPACE_L2DIST_MAX)
            .value("MULTIPLE_LABLE_SPACE_GEODIST_SO3", MULTIPLE_LABLE_SPACE_GEODIST_SO3)
            .export_values();
